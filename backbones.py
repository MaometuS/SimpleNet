...
_BACKBONES = {
    ...
    # IMAGENET1K_V1 is what `pretrained=True` used to load and what all
    # SimpleNet/PatchCore reference results are built on. DEFAULT resolves to
    # IMAGENET1K_V2 (modern recipe), whose features break the calibration of
    # noise_std and cost several AUROC points on MVTec (see exp_00 vs Original).
